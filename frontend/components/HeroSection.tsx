...
export function HeroSection() {
    ...
    // Transforms the scroll position into a motion value for y-position (parallax effect)
    const y = useTransform(scrollYProgress, [0, 1], ['-50%', '30%']);
    
    // Transforms the scroll position to scale the image
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        {/* FIX: Removed asChild and wrapped Link */}
                                        <Button
                                            size="lg"
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                >
                                    <img
                                        ...
                                        src="https://cosmic.shadcnuikit.com/hero.png"
                                        alt="app screen"
                                        width="2700"
                                        height="1440"
                                    />
