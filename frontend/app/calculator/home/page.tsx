...
// const calculators = [
//   { title: "Loan EMI Calculator", desc: "Calculate Equated Monthly Installments for any type of loan with flexible tenure and interest rate options to plan your repayments effectively.", link: "/calculator/loan-emi", color: "bg-[#fefaf6]", icon: CreditCard },
//   { title: "SIP Calculator", desc: "Estimate potential returns from your Systematic Investment Plan investments with compounding benefits over your chosen time horizon.", link: "/calculator/sip", color: "bg-[#f8f9ff]", icon: PiggyBank },
//   { title: "FD Calculator", desc: "Calculate maturity amount for Fixed Deposits with various interest payout options and compare different tenure scenarios.", link: "/calculator/fd", color: "bg-[#f0f8f4]", icon: Landmark },
//   { title: "RD Calculator", desc: "Determine the maturity value of your Recurring Deposit investments with regular monthly contributions and compounding interest.", link: "/calculator/rd", color: "bg-[#fefaf6]", icon: Wallet },
//   { title: "Retirement Calculator", desc: "Plan your retirement corpus by estimating future needs based on current expenses, inflation, and expected returns on investments.", link: "/calculator/retirement", color: "bg-[#f8f9ff]", icon: TrendingUp },
//   { title: "PPF Calculator", desc: "Calculate maturity amount for Public Provident Fund accounts with tax-free returns and long-term wealth creation benefits.", link: "/calculator/ppf", color: "bg-[#f0f8f4]", icon: BarChart3 },
//   { title: "Lump Sum Calculator", desc: "Estimate potential returns on one-time investments through mutual funds or other instruments with varying return expectations.", link: "/calculator/lumpsum", color: "bg-[#fefaf6]", icon: Coins },
//   { title: "Tax Calculator", desc: "Calculate your annual income tax liability under the old and new tax regimes to optimize your tax-saving investments.", link: "/calculator/tax", color: "bg-[#f8f9ff]", icon: Calculator },
//   { title: "Home Loan Calculator", desc: "Plan your home loan EMIs, total interest outgo, and affordability based on property price, loan amount, and interest rates.", link: "/calculator/home-loan", color: "bg-[#f0f8f4]", icon: House },
//   { title: "Car Loan Calculator", desc: "Calculate monthly installments for your car loan and understand the total cost of ownership including interest payments.", link: "/calculator/car-loan", color: "bg-[#fefaf6]", icon: Car },
//   { title: "Education Loan Calculator", desc: "Plan your education loan repayment with moratorium period consideration and estimate total interest payable over the loan tenure.", link: "/calculator/education-loan", color: "bg-[#f8f9ff]", icon: GraduationCap },
//   { title: "Gold Loan Calculator", desc: "Calculate loan amount eligibility against gold, EMI options, and interest costs for different loan-to-value ratios.", link: "/calculator/gold-loan", color: "bg-[#f0f8f4]", icon: Coins },
// ];
...
//           Comprehensive tools to help you plan loans, investments, and achieve
...
//             >
//               <Card
//                 className={`${calc.color} shadow-md rounded-2xl hover:shadow-2xl transition-all duration-300 border border-gray-100 h-full flex flex-col`}
//               >
...
//                     {calc.desc}
//                   </p>
//                   <Link href={calc.link} className="mt-auto">
