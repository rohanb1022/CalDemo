...
const calculators = [
  { 
    ...
    desc: "Calculate Equated Monthly Installments for any type of loan with flexible tenure and interest rate options to plan your repayments effectively.", 
  ...
  { 
    ...
    desc: "Estimate potential returns from your Systematic Investment Plan investments with compounding benefits over your chosen time horizon.", 
    link: "/calculator/sip",
    color: "bg-[#f8f9ff]",
    icon: PiggyBank,
  },
  { 
    title: "FD Calculator", 
    desc: "Calculate maturity amount for Fixed Deposits with various interest payout options and compare different tenure scenarios.", 
    link: "/calculator/fd",
    color: "bg-[#f0f8f4]",
    icon: Landmark,
  },
  ...
  { 
    ...
    desc: "Plan your retirement corpus by estimating future needs based on current expenses, inflation, and expected returns on investments.", 
  ...
  { 
    ...
    desc: "Estimate potential returns on one-time investments through mutual funds or other instruments with varying return expectations.", 
  ...
  { 
    ...
    desc: "Calculate your annual income tax liability under the old and new tax regimes to optimize your tax-saving investments.", 
    link: "/calculator/tax",
    color: "bg-[#f8f9ff]",
    icon: Calculator,
  },
